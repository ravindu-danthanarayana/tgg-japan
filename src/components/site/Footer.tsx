    ...
    <footer className="bg-[color:var(--ink)] text-[color:var(--paper)]">
      <div className="container-page py-20 grid gap-14 lg:grid-cols-12">
        <div className="lg:col-span-5">
          <div className="flex items-center gap-3">
            <span className="grid h-12 w-12 place-items-center rounded-md bg-[color:var(--paper)] p-1">
              <img
                src={tggLogo}
                alt="Trans Gulf Global (Pvt) Ltd"
                className="h-full w-full object-contain"
              />
            </span>
            <div>
              <div className="text-base font-semibold">Trans Gulf Global (Pvt) Ltd</div>
              <div className="mono text-[10px] tracking-widest uppercase opacity-60">
                日本向け人材支援
              </div>
            </div>
          </div>
          ...
          <Link
            to="/contact"
            className="btn-primary mt-8 bg-[color:var(--paper)] text-[color:var(--ink)] hover:bg-[color:var(--brand-red)] hover:text-white"
          >
        ...
        <div className="lg:col-span-3">
          <div className="mono text-[10px] tracking-widest uppercase opacity-50 mb-5">
            サイト内リンク
          </div>
        ...
        <div className="lg:col-span-4">
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex gap-3">
              <Mail className="h-4 w-4 mt-0.5 opacity-60" />
              <a href="mailto:japan@tggkandy.com" className="hover:text-[color:var(--brand-red)]">
                japan@tggkandy.com
              </a>
            </li>
            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              <Phone className="h-4 w-4 mt-0.5 opacity-60" />
              <a href="tel:+94775300221">+94 77 5300221</a>
            </li>
            <li className="flex gap-3">
              <Globe className="h-4 w-4 mt-0.5 opacity-60" />
              <a href="https://www.tggkandy.com" className="hover:text-[color:var(--brand-red)]">
                www.tggkandy.com
              </a>
            </li>
          </ul>
          <div className="mt-8 p-4 rounded-xl border border-white/10">
            <div className="mono text-[10px] tracking-widest uppercase opacity-50">
              認可・コンプライアンス
            </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-page py-6 flex flex-col md:flex-row gap-3 items-start md:items-center justify-between text-xs opacity-60">
          <div className="space-y-1">
            <div>
              © {new Date().getFullYear()} Trans Gulf Global (Pvt) Ltd. 無断転載を禁じます。
            </div>
            <div>
              Developed by{" "}
              <a
                href="https://www.lashuraglobal.com/"
                className="underline hover:text-[color:var(--brand-red)]"
              >
                Lashura Global (Pvt) Ltd
              </a>
            </div>
          </div>
